        ...
        fetch('/history_dy')
                ...
                .then (database_dy => {
                        ...
                        if (database_dy.length > 0) {
                                ...
                                let status = "Good";
                                let effects = ["Recomendations: None.", "Recomendations: Consider reducing exertion for sensitive people.", "Recomendations: Reduce exertion for sensitive people, people with asthma, and people with heart disease.", "Recomendations: Avoid exertion for sensitive people, people with asthma, and people with heart disease. The general public should reduce exertion.", "Recomendations: Avoid all activity for sensitive people, people with asthma, and people with heart disease. The general public should avoid exertion.", "Recomendations: Avoid contact with contaminated air for sensitive people, people with asthma, and people with heart disease. The general public should avoid all activity"]; 
